...
export const InviteFriendRighitSideItem = ({ user, isDelete, checked, onChange }: InviteFriendItem) => {
  ...
  return (
     <div className="flex flex-row justify-between h-18 items-center w-full border-b-1 border-b-white/10">
     <Image
        src={user.avatar}
